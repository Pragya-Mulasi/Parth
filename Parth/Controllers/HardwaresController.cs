...
namespace Parth.Controllers
{
    public class HardwaresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HardwareId,Model,OS,Company")] Hardware hardware)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HardwareId,Model,OS,Company")] Hardware hardware)
        {
            if (ModelState.IsValid)
            {
